...
\\
use tables with name of the methods rather than diagramith name of the methods rather than diagram
\\
...
The usage of RESTful requests is clearly visible in the sequence diagrams included in the Runtime View section \ref{sec:Runtime} \\
