...
\begin{itemize}
	...
	\item \textbf{409 Conflict}: Indicates that the request could not be processed because of conflict in the current state of the resource, such as an edit conflict between multiple simultaneous updates.
\end{itemize}
\subsubsection{Login}
\begin{figure}[ht]
\centering
...
\subsubsection{Visualize public available data on the map}
