...
\begin{figure}[ht]
\centering
	\includegraphics[width=0.80\textwidth]{images/traffic-warden-report.png}
	...
	\begin{center}
		...
		\vspace{2mm}
			...
			\begin{tabular}{p{1.3cm}|p{1.8cm}|p{6.7cm}}
				...
				03/12/19 & \makebox[1.8cm][c]{t} & \makebox[6.7cm][c]{Architectural design}\\
				\hline
				total    & \makebox[1.8cm][c]{19}
			\end{tabular}
	\end{center}
