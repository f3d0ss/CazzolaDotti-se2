		...
		\begin{itemize}
			...
			\item \textbf{GET /ranking}:
				...
				\begin{itemize}
					...
					\item \textbf{Return}:
						\begin{itemize}
							\item ranking: List<String> , ordered list of license plate
						\end{itemize}
				\end{itemize}
			\item \textbf{GET /suggestion}:
				...
				\begin{itemize}
					...
					\item \textbf{Return}:
						\begin{itemize}
							\item suggestions: List<Suggestion>
						\end{itemize}
				\end{itemize}
